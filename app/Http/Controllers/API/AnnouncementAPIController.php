...
class AnnouncementAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse(AnnouncementResource::collection($announcements), 'Announcements retrieved successfully');
    }
    ...
    public function store(CreateAnnouncementAPIRequest $request)
    {
        ...
        return $this->sendResponse(new AnnouncementResource($announcement), 'Announcement saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new AnnouncementResource($announcement), 'Announcement retrieved successfully');
    }
    ...
    public function update($id, UpdateAnnouncementAPIRequest $request)
    {
        ...
        return $this->sendResponse(new AnnouncementResource($announcement), 'Announcement updated successfully');
    }
