            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-8">
                            <div class="form-wrap">
                                {!! Form::model($courseClass, ['class'=>'form-horizontal', 'route' => ['courseClasses.update', $courseClass->id], 'method' => 'patch']) !!}
                                ...
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <a href="{{ route('courseClasses.index') }}" class="btn btn-default">Cancel</a>
                                </div>
                                {!! Form::close() !!}                        
                            </div>
                        </div>
