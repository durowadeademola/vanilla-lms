            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-8">
                            <div class="form-wrap">
                                {!! Form::model($calendarEntry, ['class'=>'form-horizontal', 'route' => ['calendarEntries.update', $calendarEntry->id], 'method' => 'patch']) !!}
                                ...
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <a href="{{ route('calendarEntries.index') }}" class="btn btn-default">Cancel</a>
                                </div>
                                {!! Form::close() !!}                        
                            </div>
                        </div>
